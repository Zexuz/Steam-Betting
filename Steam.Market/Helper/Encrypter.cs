...
namespace Steam.Market.Helper
{
    internal static class Encrypter
    {
        ...
        private static string EncryptPassword(EncrypterModel encrypterModel)
        {
            // Convert the public keys to BigIntegers
            var modulus = CreateBigInteger(encrypterModel.PublicKeyMod);
            var exponent = CreateBigInteger(encrypterModel.PublicKeyExp);
            ...
            var encryptedNumber = Pkcs1Pad2(encrypterModel.Password, (2048 + 7) >> 3);
